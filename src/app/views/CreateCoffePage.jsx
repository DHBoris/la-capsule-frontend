...
import CreateCoffeeContent from '../components/CreateCoffeeContent';

const CreateCoffePage = () => {
    return (
        <div className="page">
            <CreateCoffeeContent></CreateCoffeeContent>
            <CafePerso></CafePerso>
            <Carousel
...
export default CreateCoffePage